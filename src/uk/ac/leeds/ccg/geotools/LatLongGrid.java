...
public class LatLongGrid extends uk.ac.leeds.ccg.geotools.SimpleLayer
{
    double olatStep=20,olonStep=20;
    int latDiv=18,lonDiv=36;
...
//				latStep=lonStep=Math.max(Math.min(latStep,lonStep),5.0);
        ...
        System.out.println("x/lat "+x+" "+xstart+" "+latStep+" "+inc);
        ...
        System.out.println("y/lon "+y+" "+ystart+" "+lonStep+" "+inc);
